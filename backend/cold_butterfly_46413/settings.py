"""
Django settings for cold_butterfly_46413 project.
...
ROOT_URLCONF = 'cold_butterfly_46413.urls'
...
WSGI_APPLICATION = 'cold_butterfly_46413.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_butterfly_46413 API",
    "DESCRIPTION": "API documentation for cold_butterfly_46413 App",
    "VERSION": "v1",
}
